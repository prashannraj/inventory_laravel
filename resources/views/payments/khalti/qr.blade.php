...
<head>
    ...
    <title>Pay with Khalti - QR Code</title>
...
<body>
            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header text-white" style="background-color: #5c2d91;">
                        <h3 class="mb-0"><i class="fas fa-qrcode"></i> Scan QR Code to Pay with <span class="khalti-brand">Khalti</span></h3>
                    </div>
                    <div class="card-body">
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle"></i> 
                            Please scan the QR code below with your Khalti app to complete payment. 
                            The sale will be automatically completed once payment is received.
                        </div>

                        <div class="qr-container">
                            <h4 class="text-center mb-4">Payment Amount: <span style="color: #5c2d91;">NPR {{ number_format($amount, 2) }}</span></h4>
                            
                            <div id="qrcode"></div>
                            
                            <div class="text-center mt-3">
                                <small class="text-muted">Scan this QR code with Khalti app</small>
                            </div>
                            ...
                            <div class="mt-4 text-center">
                                <p class="text-muted">
                                    <i class="fas fa-mobile-alt"></i> Open Khalti app → Scan QR Code → Confirm Payment
                                </p>
                                <div class="d-flex justify-content-center gap-3">
                                    <a href="{{ route('sales.pos') }}" class="btn btn-outline-secondary">
                                        <i class="fas fa-arrow-left"></i> Back to POS
                                    </a>
                                    <button class="btn btn-primary" onclick="initiateKhaltiPayment()">
    ...
    <script>
        ...
        function initiateKhaltiPayment() {
            ...
            window.location.href = "{{ route('khalti.pay') }}?amount={{ $amount }}&product_name={{ urlencode($productName) }}";
        }
    </script>
</body>
</html>